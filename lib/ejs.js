...
Template.prototype = {
  ...
  , compile: function () {
    ...
    try {
      var fnParamsString = opts.localsName + ', escape, include, rethrow';
      if (opts.moreLocals.length) {
        fnParamsString += ', ' + opts.moreLocals.join(', ');
      }

      console.log(fnParamsString);
      fn = new Function(fnParamsString, src);
    }
    catch(e) {
    ...
    var returnedFn = function () {
      ...
      return fn.apply(opts.context, [data || {}, escape, include, rethrow].concat(args));
    };
