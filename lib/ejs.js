...
Template.prototype = {
  ...
  , compile: function () {
    ...
    try {
      fn = new Function(opts.localsName + ', escape, include, rethrow, req', src);
    }
    catch(e) {
    ...
    var returnedFn = function (data, req) {
      ...
      return fn.apply(opts.context, [data || {}, escape, include, rethrow, req]);
    };
